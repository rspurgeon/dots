...
" Resize splits
map <leader>F :vertical resize +10
map <leader>D :vertical resize -10
...
" => wildfire
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
nmap <leader>s <Plug>(wildfire-fuel)
...
nnoremap <leader>t :call UseSpaces()<CR>
