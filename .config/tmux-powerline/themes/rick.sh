...
if [ -z $TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
        "hostname $MY_BG_COLOR $MY_FG_COLOR" \
        "vcs_branch $MY_BG_COLOR $MY_FG_COLOR ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		"pwd $MY_BG_COLOR $MY_FG_COLOR ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
	    "date_day $MY_BG_COLOR $MY_FG_COLOR ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		"date $MY_BG_COLOR $MY_FG_COLOR ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN} 0 0 left_disable separator_disable" \
		"time $MY_BG_COLOR $MY_FG_COLOR ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN} 0 0 both_disable separator_disable" \
