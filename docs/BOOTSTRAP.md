...
profile using the existing iwd key without binding the legacy `wlan0` name;
NetworkManager can therefore autoconnect it after predictable interface renaming.
